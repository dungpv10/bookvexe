...
<form method="POST" action="{{ route('routes.update', $route->id) }}" id="frmEditRoute">
    ...
    <div class="row form-group">
        ...
        <input id="start_time" class="form-control" type="number" name="start_time" value="{{ $route->start_time }}">
    </div>
    <div class="row form-group">
        <label for="arrived_time">Giờ đến</label>
        <input id="arrived_time" class="form-control" type="number" name="arrived_time" value="{{ $route->arrived_time }}">
    </div>

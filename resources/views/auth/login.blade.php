                        ...
                        <div id="login" class="animate form">
                            <form action="/login" autocomplete="on" method="post">
                                ...
                                <p>
                                    ...
                                    <input id="username" name="email" required type="text" placeholder="username or e-mail" value="{{ old('email') }}"/>
                                </p>
                                <p>
                        ...
                        <div id="forgot" class="animate form">
                            <form action="/password/email" autocomplete="on" method="post">
                                ...
                                <p>
                                    ...
                                    <input id="emailsignup1" name="email" value="{{ old('email') }}" required type="email" placeholder="your@mail.com" />
                                </p>
                                <p class="login button">
                                    {!! csrf_field() !!}

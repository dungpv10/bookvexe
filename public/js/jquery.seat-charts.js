...
(function($) {
	...
	$.fn.seatCharts = function (setup) {
			...
			seat = (function(seatCharts, seatChartsSettings) {
				return function (setup) {
					...
					fn.settings.$node
						...
						// custom for add css wrap position seat
						.html('<div class="wrapper">' + fn.settings.label + '</div>')
		...
		$.each(settings.map, function(row, characters) {
			// TODO custom add class css width element
			var length_row = characters.length;
			jQuery('.control-seat').addClass('row-seat-'+length_row);
			var $row = $('<div></div>').addClass('seatCharts-row').addClass('seatCharts-row-'+length_row);
